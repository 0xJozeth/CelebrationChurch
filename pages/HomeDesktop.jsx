		...
		<>
			<div className='flex justify-center items-center w-[100vw]'>
				<div className='flex flex-col w-full max-w-[1728px] gap-y-16 items-center'>
					<div className='flex relative justify-center w-full h-[1343px] gap-x-16'>
						<div className='flex flex-col items-start w-full h-full '>
							<div className='flex w-full relative'>
								<div className='relative flex justify-start my-16 h-[256px] w-[600px]'>
									<div className='absolute font-display font-extra-bold text-[#f8f8f8] mix-blend-overlay text-[88px] md:text-[112px] lg:text-[152px] xl:text-[192px]  p-8 z-30'>
										<h1 className=''>
											WELCOME
											<br />
									...
									<div className='absolute font-display font-extra-bold text-[#070707] text-[88px] md:text-[112px] lg:text-[152px] xl:text-[192px] p-8 z-0'>
										<h1 className=''>
											WELCOME
											<br />
											<span className='font-kepler italic font-thin text-[1.1em] '>
